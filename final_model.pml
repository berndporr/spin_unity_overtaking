...
mtype = {left, right}
mtype lane = left;
int pos_autonomous = 10, pos_oncoming = 0, pos_other = 11, pos_next_oncoming = 21, pos_rear = 0; /* Declare initial starting positions */
byte num_obstacles = 2;
byte obstacles[num_obstacles] = {11,14};
byte road_length = 50;
